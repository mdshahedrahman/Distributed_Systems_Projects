...
class PaxosProtocol:
    ...
    def run_paxos(self, value):
        ...
        while attempts < max_attempts:
            ...
            prepare_responses.sort(reverse=True)  # Sort by highest proposed round
            ...
            if accepted_count >= majority:
                ...
                round_num += 1
                attempts += 1
                time.sleep(1)  # Introduce delay to simulate network latency


if __name__ == "__main__":
    # Create nodes
    node1 = PaxosNode(1, None)
    ...
    final_value = paxos.run_paxos("Decree Value")

    print("Final Decree Value:", final_value)
